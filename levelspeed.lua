...
function Cheats()
WriteFloat(ReadLong(SoraCurrentSpeed)+0x128, ReadByte(Save+0x24FF)/2 + 7.5, true) -- Base Running Speed
WriteFloat(ReadLong(SoraCurrentSpeed)+0x12C, ReadByte(Save+0x24FF)/2 + 1.5, true) -- Base Walking Speed
